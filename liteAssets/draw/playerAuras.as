...
package liteAssets.draw
{
    ...
    public class playerAuras extends MovieClip 
    {
        ...
        public function playerAuras(_arg_1:MovieClip)
        {
        ...
        public function handleAura(_arg_1:Object):*
        {
            ...
            {
                if (_local_4.tInf.indexOf("p") != -1)
                {
                    if (_local_4.tInf.substring(2) == rootClass.sfc.myUserId)
                    {
                        if (_local_4.auras)
                        {
                            for each (_local_5 in _local_4.auras)
                            {
                                if (_local_4.cmd.indexOf("+") > -1)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        for each (_local_6 in rootClass.world.myAvatar.dataLeaf.auras)
                                        {
                        ...
                        else
                        {
                            if (_local_4.cmd.indexOf("+") > -1)
                            {
                                ...
                                else
                                {
                                    ...
                                    for each (_local_7 in rootClass.world.myAvatar.dataLeaf.auras)
                                    {
