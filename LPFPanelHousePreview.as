...
package 
{
    ...
    public class LPFPanelHousePreview extends LPFPanel 
    {
        ...
        override public function fOpen(_arg_1:Object):void
        {
            ...
            addFrame(_local_3);
            _local_3 = {};
            _local_3.frame = new LPFFrameHousePreview();
            _local_3.fData = null;
            _local_3.r = {
                "x":18,
                "y":40,
            ...
            addFrame(_local_3);
            _local_3 = {};
            _local_3.frame = new LPFFrameHouseDesc();
            _local_3.fData = null;
            _local_3.r = {
                "x":18,
                "y":245,
            ...
            _local_3.eventTypes = ["listItemASel", "updateQtyValue"];
            addFrame(_local_3);
            _local_3 = {};
            ...
            addFrame(_local_3);
            if (fParent.sMode.toLowerCase().indexOf("shop") > -1)
            {
                _local_3 = {};
