...
package 
{
    ...
    public class GUID 
    {
        ...
        {
            var so_guid:SharedObject = SharedObject.getLocal("AQW_GUID");
            if (so_guid.size == 0)
            {
                so_guid.data.guid = create();
                try
                {
                    so_guid.flush();
                }
        ...
        public static function create():String
        {
            ...
            var _local_5:String = calculate((((_local_2 + _local_4) + _local_3) + counter++)).toUpperCase();
