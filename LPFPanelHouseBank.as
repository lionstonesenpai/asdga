...
package 
{
    ...
    public class LPFPanelHouseBank extends LPFPanel 
    {
        ...
        public function LPFPanelHouseBank():void
        {
            x = 0;
            y = 0;
            frames = [];
        ...
        override public function fOpen(_arg_1:Object):void
        {
            ...
            _local_4.sortOrder = ["House", "Wall Item", "Floor Item"];
            _local_4.filterMap = {
                "House":["House"],
                "Wall Item":["Wall Item"],
            ...
            _local_4.fData = {"sText":"Regular Bank"};
            _local_4.r = {
                "x":170,
                "y":-38,
                "w":-1,
            ...
            addFrame(_local_4);
            var _local_6:bankFilters = new bankFilters(MovieClip(stage.getChildAt(0)));
            _local_6.x = 360;
            _local_6.y = 14;
            addChild(_local_6);
            _local_4 = {};
