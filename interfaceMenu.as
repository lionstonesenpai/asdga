...
package 
{
    ...
    public class interfaceMenu extends MovieClip 
    {
        ...
        {
            if (((rootClass.world.strMapName.toLowerCase() == "house") && (rootClass.world.isMyHouse())))
            {
        ...
        private function charPage():void
        {
            ...
            {
                navigateToURL(new URLRequest(("https://www.aq.com/embed/bbgames/aw-character.asp?id=" + _local_1)), "_blank");
            }
            else
            {
                navigateToURL(new URLRequest(("https://www.aq.com/aw-character.asp?id=" + _local_1)), "_blank");
            };
        }
