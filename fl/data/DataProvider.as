...
package fl.data
{
    ...
    public class DataProvider extends EventDispatcher 
    {
        ...
        {
            var _local_2:uint = getItemIndex(_arg_1);
            if (_local_2 == -1)
            {
                return;
            };
        ...
        {
            checkIndex(_arg_2, data.length);
            var _local_3:Array = getDataFromObject(_arg_1);
        ...
        {
            var _local_6:Object;
            var _local_2:Array = getDataFromObject(_arg_1);
            var _local_3:uint = _local_2.length;
            var _local_4:uint = data.length;
        ...
        public function removeItemAt(_arg_1:uint):Object
        {
            ...
            var _local_2:Array = data.splice(_arg_1, 1);
        ...
        {
            var _local_2:int = getItemIndex(_arg_1);
            if (_local_2 != -1)
            {
        ...
        {
            var _local_1:Array = data.concat();
        ...
        {
            var _local_3:int = getItemIndex(_arg_2);
            if (_local_3 != -1)
            {
        ...
        public function replaceItemAt(_arg_1:Object, _arg_2:uint):Object
        {
            ...
            var _local_3:Array = [data[_arg_2]];
        ...
        public function sort(... _args):*
        {
            ...
            var _local_2:Array = data.sort.apply(data, _args);
        ...
        {
            dispatchPreChangeEvent(DataChangeType.SORT, data.concat(), 0, (data.length - 1));
            var _local_3:Array = data.sortOn(_arg_1, _arg_2);
            dispatchChangeEvent(DataChangeType.SORT, data.concat(), 0, (data.length - 1));
            return (_local_3);
        }
