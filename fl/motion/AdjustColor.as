...
package fl.motion
{
    public class AdjustColor 
    {
        ...
        public function set brightness(_arg_1:Number):void
        {
            ...
            if (_arg_1 != 0)
            {
                this.m_brightnessMatrix.SetBrightnessMatrix(_arg_1);
            };
        }
        ...
        public function set contrast(_arg_1:Number):void
        {
            ...
            else
            {
                if (_arg_1 > 0)
                {
                    _local_2 = ((s_arrayOfDeltaIndex[int(_arg_1)] * 127) + 127);
                }
                else
                {
                    _local_2 = (((_arg_1 / 100) * 127) + 127);
                };
            };
            ...
            this.m_contrastMatrix.SetContrastMatrix(_local_2);
        }
        ...
        public function set saturation(_arg_1:Number):void
        {
            ...
            else
            {
                if (_arg_1 > 0)
                {
                    _local_2 = (1 + ((3 * _arg_1) / 100));
                }
                else
                {
                    _local_2 = ((_arg_1 / 100) + 1);
                };
            };
            ...
            this.m_saturationMatrix.SetSaturationMatrix(_local_2);
        }
        ...
        public function set hue(_arg_1:Number):void
        {
            ...
            if (_arg_1 != 0)
            {
                this.m_hueMatrix.SetHueMatrix(((_arg_1 * Math.PI) / 180));
            };
        }
